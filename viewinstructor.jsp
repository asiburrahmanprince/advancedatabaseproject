...
try{
    ...
    ResultSet rs= st.executeQuery("select * from instructorlist" );
...
%>     
<table class="table"  width="100" style="width:100%">
  <form action="viewdeptinstructor.jsp">
  <tr width="50%">
    
    <%--<button class="joinButton2" style="vertical-align:middle"> <span>DEPARTMENT </span></button>--%>
